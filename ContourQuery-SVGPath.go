...
func (s *ContourQuary) svgpath(r io.Reader) (err error) {
	rd := newSVGReader(r)
	// command parser
	//
	...
	for bts, from, to, err =rd.NextFromTo(); err == nil; bts, from, to, err =rd.NextFromTo() {
...
func dosvgpath(cq *ContourQuary, c svgpathCommand, stack *svgpathStack) error {
	stack.do()
	//
	switch c.Fn {
	case 'M':
...
// MoveTo
func dosvgpathM(cq *ContourQuary, c svgpathCommand, stack *svgpathStack) error {
...
// LineTo
func dosvgpathL(cq *ContourQuary, c svgpathCommand, stack *svgpathStack) error {
	vts, err := vectors(c.Args)
	if err != nil {
		return errors.WithMessage(ErrorSVGPathSyntax, err.Error() + " : " + c.debugmsg())
	}
...
// QuadTo
func dosvgpathQ(cq *ContourQuary, c svgpathCommand, stack *svgpathStack) error {
	vts, err := vectors(c.Args)
	if err != nil {
		return errors.WithMessage(ErrorSVGPathSyntax, err.Error() + " : " + c.debugmsg())
	}
...
// smooth QuadTo
func dosvgpathT(cq *ContourQuary, c svgpathCommand, stack *svgpathStack) error {
	vts, err := vectors(c.Args)
	if err != nil {
		return errors.WithMessage(ErrorSVGPathSyntax, err.Error() + " : " + c.debugmsg())
	}
...
// CubeTo
func dosvgpathC(cq *ContourQuary, c svgpathCommand, stack *svgpathStack) error {
	vts, err := vectors(c.Args)
	if err != nil {
		return errors.WithMessage(ErrorSVGPathSyntax, err.Error() + " : " + c.debugmsg())
	}
...
// smooth CubeTo
func dosvgpathS(cq *ContourQuary, c svgpathCommand, stack *svgpathStack) error {
	vts, err := vectors(c.Args)
	if err != nil {
		return errors.WithMessage(ErrorSVGPathSyntax, err.Error() + " : " + c.debugmsg())
	}
